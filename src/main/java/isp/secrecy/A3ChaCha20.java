...
public class A3ChaCha20 {
    public static void main(String[] args) throws Exception {
        // STEP 1: Alice and Bob beforehand agree upon a cipher algorithm and a shared
        // secret key
        ...
        env.add(new Agent("alice") {
            ...
            public void task() throws Exception {
                ...
                for (int i = 1; i <= 10; i++) {
                    /*
                     * STEP 3:
                     * Alice creates, encrypts and sends a message to Bob. Bob replies to the
                     * message.
                    ...
                    if (i < 10) {
                        ...
                        decrypt.init(Cipher.DECRYPT_MODE, key, new ChaCha20ParameterSpec(bobNonce, 1));
            ...
            public void task() throws Exception {
                ...
                for (int i = 1; i <= 10; i++) {
                    ...
                    if (i < 10) {
                        ...
                        encrypt.init(Cipher.ENCRYPT_MODE, key, new ChaCha20ParameterSpec(replyNonce, 1));
